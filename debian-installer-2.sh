...
## Git cloning of compiled Kernal)
echo "Downloading kernel source from git"
cd /home/$F
git clone https://github.com/nevik-xx/ps3-linux-kernel-2.6.39-tar.git
cd ps3-linux-kernel-2.6.39-tar
tar -xvf ps3_linux_kernel_latest.tar.gz
cp boot/* /boot/
